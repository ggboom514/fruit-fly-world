...
| 想改什么 | 文件 | 字段 | 现在 |
| --- | --- | --- | --- |
| 各突变的概率和效果 | `config.js` | `mutation.types[]` | 疯狂 2.9% / 点石成金 3% / 石化 2% / 炫彩 1.1% / 星云 **0** |
...
> 只动一个数几乎没用 —— 炫彩从 1.1% 砍到 0.55%，普通率只从 91.3% 挪到 91.7%。
...
>   想再动先问一句。
>
> 两个后果，都是刻意的：稀有突变永远稀有（带炫彩的父母，孩子照样只有 1.1%）；
